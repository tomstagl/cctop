...
pub const METRICS: &[Metric] = &[
    ...
    metric!(agents_cost, "Tokens & Cost", "Agents cost", "USD", "Priced usage of every subagent transcript (incl. `subagents/workflows/**`) and its share of the session's total", ["D6", "D9"], "", "≈ (priced from the table)"),
