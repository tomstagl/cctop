...
**Design:** the canvas *cctop Dashboard Redesign* (https://claude.ai/artifact/1WvbQBFa3mKqyVPZ8YuWmy) — pages *Redesign*, *Colour & k9s*, *Directions*, *Console*. Sources and a standalone clickable prototype in `tasks/design-dashboard-v2/`; see its README for which artboard carries which decision.
